...
현재 시작점은 새 실행 정본의 **R30 sms-contacts**입니다.
...
R18 layouts 18개, R19 theme 11개, R20 points 19개와 R21~R29의
polls·popups·popular·visits·reports·qa·write-count·mails·sms config는 공식 G5 5.6.32
실런타임·반응형 브라우저 readback까지 tracked 증거로 닫았고, 남은 114개 finding은
