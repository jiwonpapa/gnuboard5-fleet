...
현재 시작점은 새 실행 정본의 **R19 theme**입니다.
...
R15 contents 13개, R16 faq-masters·faqs 31개, R17 menus 17개와
R18 layouts 18개는 공식 G5 5.6.32 실런타임·반응형 브라우저 readback까지
tracked 증거로 닫았고, 남은 270개는
