...
#[tauri::command]
pub async fn cmd_admin_poll_create(
    ...
    let Traced { value, trace } = execute_with_access_token(
        ...
        |access_token, app_state, request_id| {
            ...
            async move {
                app_state
                    .api_client
                    .create_admin_poll(&request_id, &access_token, &input)
                    .await
            }
        },
    )
...
#[tauri::command]
pub async fn cmd_admin_poll_update(
    state: State<'_, AppState>,
    ...
    let Traced { value, trace } = execute_with_access_token(
        ...
        |access_token, app_state, request_id| {
            ...
            async move {
                app_state
                    .api_client
                    .update_admin_poll(&request_id, &access_token, &input)
                    .await
            }
        },
    )
...
#[tauri::command]
pub async fn cmd_admin_poll_delete(
    state: State<'_, AppState>,
    ...
    let trace = execute_with_access_token(
        ...
        |access_token, app_state, request_id| {
            ...
            async move {
                app_state
                    .api_client
                    .delete_admin_poll(&request_id, &access_token, &input)
                    .await
            }
        },
    )
