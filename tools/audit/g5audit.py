...
def check_server_scaffold_contract(root: Path) -> str:
    ...
    expected = [
        ...
        ("GET", "/api/v1/sites/{site_id}/admin/system/phpinfo", "session", True),
        ("GET", "/api/v1/sites/{site_id}/admin/system/browscap", "session", True),
        ("POST", "/api/v1/sites/{site_id}/admin/system/browscap/update", "session_csrf_step_up_confirm_external", True),
        ("POST", "/api/v1/sites/{site_id}/admin/system/browscap/convert", "session_csrf_step_up_confirm_mutation", True),
        ("POST", "/api/v1/sites/{site_id}/admin/system/maintenance/cache-files/purge", "session_csrf_step_up_confirm_mutation", True),
        ("POST", "/api/v1/sites/{site_id}/admin/system/maintenance/captcha-files/purge", "session_csrf_step_up_confirm_mutation", True),
        ("POST", "/api/v1/sites/{site_id}/admin/system/maintenance/member-list-files/purge", "session_csrf_step_up_confirm_mutation", True),
        ("POST", "/api/v1/sites/{site_id}/admin/system/maintenance/session-files/purge", "session_csrf_step_up_confirm_mutation", True),
        ("POST", "/api/v1/sites/{site_id}/admin/system/maintenance/thumbnail-files/purge", "session_csrf_step_up_confirm_mutation", True),
